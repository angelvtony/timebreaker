...
class HomeViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private var totalShiftMillis: Long = 8 * 3600 * 1000L
    ...
    fun clockOut() {
        ...
        PrefsHelper.saveWorkStartTime(context, 0L)
